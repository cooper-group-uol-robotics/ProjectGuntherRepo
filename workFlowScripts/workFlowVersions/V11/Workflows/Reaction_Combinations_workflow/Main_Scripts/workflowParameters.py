...
generatedCsvPath =  strCWD + '/Reaction_Combinations_workflow/Generated_CSVs/'                                                                          #The path where the chemist will look at for experiment information.
generatedPicklePath = strCWD + '/Reaction_Combinations_workflow/Generated_pickles/'                                                                     #The path where any generated python objects will be saved. (For the reagent analysis workflow this is not used).
generatedJsonPath = strCWD + '/Reaction_Combinations_workflow/Generated_NMR_JSONs/'                                                                     #The path where the NMR JSON will be saved.
generatedMsCsvPath = strCWD + '/Reaction_Combinations_workflow/Generated_MS_CSV/'                                                                       #The path where the MS csv will be saved.
logsPath = strCWD + '/Reaction_Combinations_workflow/Logs/'                                                                                             #The path where the logs will be saved.
...
chemicalsInWholeSpace = [                                                                                                                                                                           
        ...
        sc.Diamine(name=',3-Benzenedimethanamine', CAS='1477-55-0', molecularWeight=136.19, solubility=(0,1), price=13, volumeInReactionVial=reactionVialTransferVolume, concentrationInStockVial=diamineConcentration, noCoordinationSites= 2, noImineReactionSites=2, newChemical=True),
