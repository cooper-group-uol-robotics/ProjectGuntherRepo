...
class USER_SELECTION():
    ...
    generated_json_path = str_cwd + '/Generated_JSONs/'
    ...
    field_presat = 20                                                                        #This is a setting for the MULTISUPPDC_f program
...
class Batch_space():
    ...
    def send_NMR_json_to_email(self):
