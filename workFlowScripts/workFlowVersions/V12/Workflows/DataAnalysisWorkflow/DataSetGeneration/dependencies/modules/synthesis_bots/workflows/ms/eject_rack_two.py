...
def main(
    ...
    if DRY:
        ...
        if result in "Completed":
            ...
            pub.send_string("[LCMSAS] Extract Rack 2 Completed\n")
        else:
            logger.error("Rack ejection failed.")
            pub.send_string("[LCMSAS] Error! Extract Rack 2\n")
        ser.close()
